...
static DEVICE_ATTR(set_update, (S_IRUGO | S_IWUSR | S_IWGRP), set_update_show, set_update_store);

static DEVICE_ATTR(bump_sample_rate, (S_IRUGO | S_IWUSR | S_IWGRP), bump_sample_rate_start, bump_sample_rate_store);
